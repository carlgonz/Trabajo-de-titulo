...
\begin{itemize}
    ...
    \item Integrar un nuevo \textit{transceiver} al \textit{software} de vuelo, dado que la solución actual ha resultado totalmente insatisfactoria por su funcionamiento anómalo. Además se recomienda integrar el protocolo CSP (\textit{Cubesat Space Protocol}) en la capa de transporte de las comunicaciones. Esto para avanzar en la estandarización de protocolos en los proyectos aeroespaciales. \cite{CSP_DOC}
\end{itemize}
