...
\begin{itemize}
	...
	\item El diseño de \textit{software} para sistemas embebidos requiere una interacción de bajo nivel. Existe una amplia gama de plataformas de \textit{hardware} para desarrollar sistemas embebidos y se requiere interactuar también con una amplia gama de dispositivos externos. Por esto se requiere desarrollar capas de controladores de periféricos que oculten las diferencias de \textit{hardware} a la aplicación final del sistema.
