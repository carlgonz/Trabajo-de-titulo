...
\figura{img/mvc_class.png}{width=\textwidth}{Diagrama de clases del patrón de diseño MVC.}{ch2:mvc:command:classes}{!h}

\figura{img/mvc_colab.png}{width=\textwidth}{Esquema de colaboración del patrón de diseño MVC.}{ch2::mvc:command:collaboration}{!h}
...
\figura{img/command_processor_class.png}{width=\textwidth}{Diagrama de clases del patrón de diseño procesador de comandos.}{ch2:patterns:command:classes}{!h}

\figura{img/command_processor_colab.png}{width=\textwidth}{Esquema de colaboración del patrón de diseño procesador de comandos.}{ch2::patterns:command:collaboration}{!h}
