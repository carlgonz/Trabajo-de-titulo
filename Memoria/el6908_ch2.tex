...
\begin{itemize}
    ...
    \item \textbf{Solución:} dividir la aplicación en tres áreas: el modelo, la vista y el controlador.
    
    \begin{itemize}
        \item \textbf{Modelo:} encapsula la información y todas las funcionalidades de la aplicación, de manera independiente de su representación gráfica.
        \item \textbf{Vista:} despliega la información al usuario, a partir de los datos del modelo. Permite múltiples formas de visualizar el modelo.
    ...
    \item \textbf{Estructura:} %TODO: Agregar imagen MVC
...
Dentro de los patrones clasificados como de comportamiento se encuentra el patrón de comandos o mejor conocido por su nombre en inglés \textit{command pattern} el cual de especial interés en este trabajo. Lo esencial de este patrón es separar el requerimiento de un servicio de su ejecución, encapsulándolo en la forma de un comando.
