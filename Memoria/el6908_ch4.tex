...
La estrategia que se toma es la de asignar a cada comando un código numérico, %TODO --- Continuar con la forma de caracterizar un comando

Finalmente todas estas definiciones son incluidas en un archivo de cabecera denominado \texttt{cmdIncludes.h} homogeneizando el tratamiento de los comandos a lo largo de la aplicación.