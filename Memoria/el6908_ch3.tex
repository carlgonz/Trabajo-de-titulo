...
% \figura2{img/mb.jpg}{scale=0.6}{Placa madre}{img/ppm.jpg}{scale=0.6}{Módulo del procesador}{Dos módulos que componen el computador a bordo del satélite}{img:ch3:obc}
...
\begin{itemize}
	...
	\item 4 UARTs, 3SPIs, 3I2Cs.
	\item ADC de 10bit, 16 canales, 500ksps.
	\item 5 timers de 16bit.
	\item RTCC, WDT
\end{itemize}

%TODO TERMINAR DESCRIPCCION DE PLATAFORMA
