...
En el diseño actual se considera la utilización de sólo un \textit{executer} considerando que el sistema no será utilizado bajo una alta demanda de ejecución de comandos según lo expresado en los requerimiento no operacionales y aprovechando la ventaja que implica librarse de requerir una gran cantidad de elementos de sincronización entre procesos concurrentes.
