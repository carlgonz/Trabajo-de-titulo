...
Tolerancia a fallos de \textit{software} & Dispatcher & Se lleva un registro de los comandos ejecutados y sus códigos de retorno. Se puede evitar le ejecución de comandos (o grupos de comandos) que están generando problemas en el sistema. (Lista negra). Se puede filtrar comandos desde ciertos \textit{listener}s.\\
...
Fallos de \textit{hardware} externo & NA & Se pueden generar comandos para que la EPS apague los buses de energía de los payloads y \textit{hardware} externo\\
...
Con esto, el resultado del diseño de la arquitectura de \textit{software} queda detallado en la figura \ref{img:ch3:dis:arch} que muestra los módulos participantes y el flujo de información en esta arquitectura:
