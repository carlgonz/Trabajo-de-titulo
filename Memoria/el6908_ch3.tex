...
\section{Plataforma}
La plataforma para la cual se diseña el \textit{software} corresponde a un kit Cubesat de una unidad (1U) de la compañía Pumpkins Inc. El kit está compuesto por los siguientes elementos:
\begin{itemize}
    \item Chasis de 1U.
...
Adicionalmente se cuenta con los siguientes dispositivos para EPS y comunicaciones respectivamente:
...
\begin{itemize}
	...
	\begin{itemize}
		\item \textbf{Modo \textit{preemptive}:} El sistema operativo puede interrumpir la actual tarea cualquier momento de su ejecución para realizar el cambio de contexto y ceder el procesador a una tarea diferente. Por lo generar se realiza a intervalos fijos, denominados \textit{ticks}. Esto puede ir acompañado de un sistema de prioridades, entonces el sistema de gestión de tareas se asegura de que siempre se esté ejecutando la tarea de mayor prioridad disponible.
