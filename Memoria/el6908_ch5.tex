...
//Lo primero en configurarse es la salida serial
...
Desde este momento comienza la segunda etapa de inicialización implementada en \texttt{taskDeployment}. En este punto ya se cuenta con todas las funcionalidades de bajo nivel y el sistema operativo funcionando. Así, se procede al inicio de todas las funciones de la capa de aplicación del \textit{software} de vuelo, incluyendo: periféricos externos, repositorios, estructuras de datos y el resto de los \textit{listeners}. En este momento se ejecuta el periodo de inactividad, si corresponde, así como el despliegue de antenas. La salida por consola, que se muestra en el registro \ref{ch5:reg:init2}, es incremental a cada función que se realiza y demuestra la correcta ejecución de la secuencia de inicio.
